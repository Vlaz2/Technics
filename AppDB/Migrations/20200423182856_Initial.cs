        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewComment = table.Column<string>(maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfirmOrder = table.Column<bool>(nullable: false),
                    Paid = table.Column<bool>(nullable: false),
                    Delivered = table.Column<bool>(nullable: false),
                    PaymentMethod = table.Column<int>(nullable: false),
                    ToTown = table.Column<string>(maxLength: 50, nullable: true),
                    PostCode = table.Column<int>(nullable: false),
                    AttendantAdminId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductId = table.Column<long>(nullable: false),
                    ImgUrl = table.Column<string>(maxLength: 400, nullable: true)
                },
                constraints: table =>
                {
